...
//Message all iframes
window.postMessage(`{"message":"stopExtension","state":${JSON.stringify(extensionState)}}`,"*")
var iFrames = document.querySelectorAll('iframe');
iFrames.forEach((e)=>{
  e.contentWindow.postMessage(`{"message":"stopExtension","state":${JSON.stringify(extensionState)}}`,"*");
})
